...
import com.ganecamp.utilities.enums.EntityType.Animal
...
class EventAddFormViewModel @Inject constructor(
    ...
    fun loadEvents() {
        viewModelScope.launch {
            ...
            if (eventResponse.second == FirestoreRespond.OK) {
    ...
    fun saveEvent() {
        viewModelScope.launch {
            ...
            if (applyEventResponse == FirestoreRespond.OK) {
